...
namespace EventBus.RabbitMQ
{
    public class EventBusRabbitMQ : BaseEventBus
    {
        ...
        public EventBusRabbitMQ(EventBusConfig config, IServiceProvider serviceProvider) : base(config, serviceProvider)
        {
            ...
            persistentConnection = new RabbitMQPersistentConnection(connectionFactory, config.ConnectionRetyCount);
        ...
        public override void Publish(IntegrationEvent @event)
        {
            ...
            var policy = Policy.Handle<BrokerUnreachableException>()
                .Or<SocketException>()
                .WaitAndRetry(EventBusConfig.ConnectionRetyCount, retryAttempt => TimeSpan.FromSeconds(Math.Pow(2, retryAttempt)), (ex, time) =>
                {
                    // log
                });
        ...
        public override void Unubscribe<T, TH>()
        {
