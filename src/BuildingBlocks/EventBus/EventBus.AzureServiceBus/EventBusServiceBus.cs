...
namespace EventBus.AzureServiceBus
{
	public class EventBusServiceBus: BaseEventBus
	{
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            logger.LogInformation("Subscribing to evetn {EventName} with {EventHandler}", eventName, typeof(TH).Name);
        ...
        public override void Unubscribe<T, TH>()
        {
            ...
            logger.LogWarning("TUnsubscribing from event {eventName}", eventName);
